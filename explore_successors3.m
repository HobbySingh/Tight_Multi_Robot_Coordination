function successors=explore_successors3(x_cell,y_cell,h,x_target,y_target,in_valid,max_x,max_y,cell_x,cell_y)
    successors=[];
    dist_array = [];
    successor_count=1;
    c2=size(in_valid,1);
...
%                         end
%                         min(dist_array);
                        if(pdist([s_x,s_y;cell_x,cell_y],'euclidean') < 4.2)
